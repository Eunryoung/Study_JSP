...
<body>
	...
	<%-- 주의! 리턴타입이 void인 메서드는 표현식(출력문)에 지정 불가! HTTP 500 에러 발생! --%>
...
<%-- 	<h3>로컬변수 str3 = <%=str3 %></h3> --%>
	...
	// 리턴타입이 void인 method1() 메서드 호출
	method1(); // 출력문이 아니므로 리턴타입 void인 메서드 호출도 가능
